        ...
        <div>
          ...
          <ol className="list-none m-0 p-0 flex flex-col">
            {SERVICES.map((service, i) => (
              <li
                key={service}
                className={`flex items-baseline gap-6 py-[22px] border-t border-[rgba(29,29,27,0.14)] last:border-b last:border-b-[rgba(29,29,27,0.14)] reveal visible stagger-${i + 1}`}
              >
